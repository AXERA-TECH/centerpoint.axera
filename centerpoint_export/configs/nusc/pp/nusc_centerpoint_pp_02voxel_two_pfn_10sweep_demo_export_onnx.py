...
db_sampler = dict(
    type="GT-AUG",
    enable=False,
    db_info_path="data/dbinfos_train_10sweeps_withvelo.pkl",
    sample_groups=[
        dict(car=2),
        dict(truck=3),
...
train_anno = "data/dbinfos_train_10sweeps_withvelo.pkl"
val_anno = "data/infos_val_10sweeps_withvelo_filter_True.pkl"
test_anno = None
